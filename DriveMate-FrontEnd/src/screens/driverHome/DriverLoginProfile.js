...
function DriverLoginProfile(props) {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View>
                <View style={{ position: 'relative' }}>
                    ...
                    <TouchableOpacity
                        style={[styles.editIcon, { top: insets.top + 5, right: insets.right + 10 }]}
                        onPress={() => {
                    ...
                    <Image
                        ...
                        source={require('../../assets/img/wave1.png')}
                    />
                </View>
                ...
                <View style={{ marginTop: 20, marginHorizontal: 25 }}>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                <Text style={styles.infoSmall_Text}>Age</Text>
                                <Text style={styles.infoLarge_Text}>
                                    {userData.age}
                                    {/* {userData.profession == '' ||
...
export default DriverLoginProfile;