  ...
  useEffect(() => {
    const fetchChats = async () => {
      try {
        ...
        console.log('PassengerId from token:', passengerId);

        const response = await axios.get(`${Config.apiBaseUrl}/driverList/${passengerId}`, {
          headers: {
    ...
    return (
      <ListItem
        ...
        onPress={() => navigation.navigate('Chat', {
          ...
          rideId: item.rideId,
          rideType: 'requested' // Specify the ride type as requested
        })}
      >
        <Avatar
          rounded
...
export default PassengerChatListScreen;
